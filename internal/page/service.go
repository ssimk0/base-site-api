...
func (s *service) FindCategories() ([]*PageCategory, error) {
...
func (s *service) FindAllByCategory(categorySlug string) ([]*Page, error) {
	return s.repository.FindAllByCategorySlug(categorySlug)
}

// Update page
func (s *service) Update(page *Page, id uint) error {
	return s.repository.Update(page, id)
}

// Store page
func (s *service) Store(page *Page, categorySlug string, userID uint) (uint, error) {
